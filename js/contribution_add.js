...
// $(".uploadimage").css('display', 'none');
        ...
        fallbackadjust();
        youtubefallbackadjust();
        $(".imageselectiondiv").center();
        $("#imageuploadpopupcenter").center();
    });


    function fallbackadjust() {

        var maxdisplaywidth = $("#listimageuploadpopuptitle").width();
        console.log("max width" + maxdisplaywidth);
        var maxdisplayheight = 300;
    ...
    function youtubefallbackadjust() {
        var maxdisplaywidth = $("#listimageuploadpopuptitle").width();
        var maxdisplaywidth = $(".contributionembedvideoholder").width();
        console.log("max width" + maxdisplaywidth);
        var maxdisplayheight = 400;
        console.log("max height" + maxdisplayheight);
        var loadedimage = $('.contributiongalleryvideofallback');
        loadedimage.width('auto');
        loadedimage.height('auto');


        var naturalwidth = $(".contributiongalleryvideofallback").width();
        var naturalheight = $(".contributiongalleryvideofallback").height();
    ...
    $.fn.center = function () {
        ...
        console.log("the innerheigght")
        console.log($(window)[0].innerHeight)
        console.log($(window)[0].innerWidth)

        // this.css("position","absolute");
        // this.css("top", 'reset');
        this.css("top", ($(window)[0].innerHeight - this.height() ) / 2 + "px");
        // this.css("left", ( $(window)[0].innerWidth - this.width() ) / 2 + "px");
        return this;
    }
...
// last = last_id;
    ...
    $(".uploadimage").on('click', function (e) {
        ...
        // $("#imageselectiondivbackground").css('z-index', '1');
        $(".x1").val(0);
        $(".y1").val(0);
        $(".x2").val(0);
        $(".y2").val(0);
...
// $("#imageuploadpopup").css({'display': 'block'});
    ...
    // $(".imageuploadpopupwrapper").on('click', function (e) {
    //
    //     $(".imageuploadpopup").css('display', 'none');
    //     $(".imageselectiondiv").css('display', 'block');
    //     $("#imageselectiondivbackground").css('z-index', '9');
    // });

    $(".imageselectiondiv").on('click', '.contributionembedvideotext', function (e) {

        $('.imageuploadpopupphoto').css('display', 'none');
        $("#imageuploadpopup").css({'display': 'block'});
        $("#listimageuploadpopuptitle").text("");
        $(".imageselectiondiv").css('display', 'none');
        $(".imageuploadpopupoverall").css('display', 'block');
        $(".imagepart").find('.contributiongalleryvideocontainer').css('display', 'block');
        $(".imagepart").find('.contributiongalleryvideocontainer').siblings().css('display', 'none');
        $(".contributionimagetext").removeClass("uploadcontributionimagevideoclasstext_selected ")
        $(".contributionembedvideotext").addClass("uploadcontributionimagevideoclasstext_selected ");
        fallbackadjust();
        youtubefallbackadjust();
        $("#imageuploadpopupcenter").center();
        $(".imageselectiondiv").center();
        // $(".gobackyoutube").addClass("gobackfromembed").removeClass("gobackfromsearch");
    });

    $(".imageselectiondiv ").on('click', '.contributionimagetext', function (e) {
        $(".contributiongalleryvideocontainer").css('display', 'none');
        $(".new_createlist_image_uploader_full").css('display', 'block');
        $(".contributionimagetext").addClass("uploadcontributionimagevideoclasstext_selected ")
        $(".contributionembedvideotext").removeClass("uploadcontributionimagevideoclasstext_selected ");
        fallbackadjust();
        youtubefallbackadjust();
        $("#imageuploadpopupcenter").center();
        $(".imageselectiondiv").center();
    ...
    $(".contributiongalleryvideocontainer").on('click', '.selectcontributionimagebuttonvideo', function (e) {
        $(".gobackyoutube").css('display', 'block');

        $('.imageuploadpopupphoto').imgAreaSelect({remove: true});
        $('.imageuploadpopupphoto').css('display', 'block').css('margin-right', 'auto').css('margin-left', 'auto');
        $("#imageuploadpopup").css({'display': 'block'});
        $("#listimageuploadpopuptitle").text("");
        $(".imageselectiondiv").css('display', 'none');
        $(".imageuploadpopupoverall").css('display', 'block');
        $(".imagepart").find('.imageuploadfromyoutubeholder').css('display', 'block');
        $(".imagepart").find('.imageuploadfromyoutubeholder').siblings().css('display', 'none');

        $("#listimageuploadpopuptitle").text("Search video in");
        // $(".imageselectiondiv").css('display', 'none');
        // $(".imageuploadpopupoverall").css('display', 'block');
        ...
        // $(".imagepart").find('.imageuploadfromyoutubeholder').css('display', 'block');
        // $(".imagepart").find('.imageuploadfromyoutubeholder').siblings().css('display', 'none');
        // $(".imageuploadpopupphoto").attr("src", "images/fallbackimages/itemvideofullsize.png").css('width', 'auto').css('height', 'auto');
        // $('.imageuploadpopupphoto').removeClass("thirdparty");
        $("#imageuploadpopupcenter").center();
        $(".imageselectiondiv").center();
        fallbackadjust();
        youtubefallbackadjust();
        $(".gobackyoutube").removeClass("gobackfromembed").addClass("gobackfromsearch");
    ...
    function youtubeadjustmargins() {

        var currentimagewidth = $(".galleryvideoframe").width();
        var currentimageheight = $(".galleryvideoframe").height();
        // if ($(".imageuploadpopupphoto").hasClass('ninetydeg') || $(".imageuploadpopupphoto").hasClass('twoseventydeg')) {

        console.log("not working in if case");
        // if ($(".imageuploadpopupphoto").hasClass('zerodeg') || $(".imageuploadpopupphoto").hasClass('oneeightydeg')) {
        if (!($.browser.msie && $.browser.version < 9)) {
            $(".galleryvideoframe").css('margin', 0);
        } else {
            $(".galleryvideoframe").css('margin-bottom', 0);
        }
        if ($.browser.msie) {
            var wrapperleftiewidth = $(".galleryvideoframe").width();
            $(".imageuploadpopupphotowrapperleft").css('width', wrapperleftiewidth).css('margin-right', 10);
        }
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                img.onload = function () {
                    ...
                    jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto');
                    ...
                    var minsize = Math.min(naturalwidth, naturalheight);


                    if ($('.imageuploadpopupphoto').hasClass('flipninetydeg') == true || $('.imageuploadpopupphoto').hasClass('fliptwoseventydeg') == true || $('.imageuploadpopupphoto').hasClass('ninetydeg') == true || $('.imageuploadpopupphoto').hasClass('twoseventydeg') == true) {
                        var imagearea = $('.imageuploadpopupphotocontainer');
                    }
                    else {
                        var imagearea = $('.imageuploadpopupphoto');
                    }
    ...
    function youtubeadjust(width, height) {

        var maxdisplaywidth = $(".contributiongalleryvideobottomnav").width();
        console.log("max width" + maxdisplaywidth);
        var maxdisplayheight = 500;
        console.log("max height" + maxdisplayheight);
        var loadedimage = $('.galleryvideoframe');
        loadedimage.width('auto');
        loadedimage.height('auto');
        ...
        var currentnaturalheight = naturalheight;
        var availableaspectratio = maxdisplaywidth / maxdisplayheight;
        console.log("available aspect_" + availableaspectratio)

        var imageaspectratio = currentnaturalwidth / currentnaturalheight;
        console.log("imageaspectratio aspect_" + imageaspectratio)
        if (imageaspectratio < availableaspectratio) {
            var scaleforimage = maxdisplayheight / currentnaturalheight;
        }
        else {
    ...
    function updateselectedimage(itemid) {
        ...
        var orientation = GetOrientation($(".imageuploadpopupphoto"));
    ...
    function windowresizeadjust() {
        console.log("this is for normal window resize")
        var maxdisplaywidth = $("#listimageuploadpopuptitle").width();
        var maxdisplayheight = 400;
        var loadedimage = $('.imageuploadpopupphoto');
        ...
        console.log("the previous width_" + previouswidth)
        console.log("the previous height_" + previousheight)
        //for getting the actual height and width of image
        loadedimage.width('auto');
        loadedimage.height('auto');
        ...
        console.log("the current width_" + currentnaturalwidth)
        console.log("the current height_" + currentnaturalheight)
        var availableaspectratio = maxdisplaywidth / maxdisplayheight;
        var imageaspectratio = currentnaturalwidth / currentnaturalheight;
        ...
        // // adjustmargins(GetOrientation($(".imageuploadpopupphoto")));
        // adjustsize(GetOrientation($(".imageuploadpopupphoto")));
    ...
    function flipwindowresizeadjust() {

        console.log("This is for flip window resize")
        var maxdisplaywidth = $("#listimageuploadpopuptitle").width();
        var maxdisplayheight = 400;
        var loadedimage = $('.imageuploadpopupphoto');

        //the resized height and width
        var previouswidth = loadedimage.height();
        var previousheight = loadedimage.width();


        //for getting the actual height and width of image
        loadedimage.width('auto');
        loadedimage.height('auto');
        var currentnaturalwidth = $(".imageuploadpopupphoto").height();
        var currentnaturalheight = $(".imageuploadpopupphoto").width();
        ...
        var ias = $(".imageuploadpopupphotocontainer").imgAreaSelect({
            onInit: function (img, selection) {
                document.iasselectionx1 = selection.x1;
                document.iasselectiony1 = selection.y1;
                document.iasselectionx2 = selection.x2;
    ...
    function adjustsizeforimagerotate() {
        ...
        if (!($.browser.msie && $.browser.version < 9)) {
            ...
            var GetOrientation = GetOrientation($(".imageuploadpopupphoto"));

            if (GetOrientation == 'ninetydeg' || GetOrientation == 'twoseventydeg' || GetOrientation == 'rotateninetydeg' || GetOrientation == 'rotatetwoseventydeg') {
                var naturalwidth = $(".imageuploadpopupphoto").height();
                var naturalheight = $(".imageuploadpopupphoto").width();
            } else {
                var naturalwidth = $(".imageuploadpopupphoto").width();
        ...
        if (loadedimage.hasClass('ninetydeg') || loadedimage.hasClass('twoseventydeg') || loadedimage.hasClass('rotateninetydeg') || loadedimage.hasClass('rotatetwoseventydeg')) {
            ...
            $(".imageuploadpopupphotocontainer").css('margin-left', 'auto').css('margin-right', 'auto')

            $(".imageuploadpopupphotocontainer").width(finalimageheight)
            $(".imageuploadpopupphotocontainer").height(finalimagewidth)
        ...
        // if (loadedimage.hasClass('zerodeg') || loadedimage.hasClass('oneeightydeg')) {
            ...
            loadedimage.width(finalimagewidth);
            loadedimage.height(finalimageheight);
            // if (loadedimage.hasClass('rotateoneeightydeg') == true){
            $(".imageuploadpopupphotocontainer").css('margin-left', 'auto').css('margin-right', 'auto')
            $(".imageuploadpopupphotocontainer").width(finalimagewidth)
            $(".imageuploadpopupphotocontainer").height(finalimageheight)
            // }
    ...
    function adjustmarginsforimagerotate() {
        ...
        if ($(".imageuploadpopupphoto").hasClass('ninetydeg') || $(".imageuploadpopupphoto").hasClass('twoseventydeg') || $(".imageuploadpopupphoto").hasClass('rotateninetydeg') || $(".imageuploadpopupphoto").hasClass('rotatetwoseventydeg')) {
            if (!($.browser.msie && $.browser.version < 9)) {
                var marginratioceil = Math.ceil((currentimagewidth - currentimageheight) / 2);
                var marginratiofloor = Math.floor(currentimagewidth - currentimageheight) / 2;
                $(".imageuploadpopupphoto").css('margin-top', +marginratioceil);
    ...
    $(".imageuploadpopup , .imageselectiondiv").on('dragover', function (e) {
        ...
        jQuery('.imageuploadpopupphoto img.imageuploadpopupphoto').attr('class', 'zerodeg');
    ...
    $('.imageuploadpopup').on("drop", function (e) {
        ...
        jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto zerodeg');
        ...
        if ($.inArray(filetype, ['gif', 'png', 'jpg', 'jpeg', 'bmp', 'x-png', 'pjpeg']) != -1 && filesize <= 4194304) {
            ...
            if (mimecheck(blob)) {
                ...
                window.onresize = function () {
                    ...
                    if (CallPageResize == true)

                        if ($('.imageuploadpopupphoto').hasClass('flipninetydeg') == true || $('.imageuploadpopupphoto').hasClass('fliptwoseventydeg') == true || $('.imageuploadpopupphoto').hasClass('ninetydeg') == true || $('.imageuploadpopupphoto').hasClass('twoseventydeg') == true) {

                            flipwindowresizeadjust();
                        }
                        else {
    ...
    $(".contributionembedvideoid").on('input propertychange', function (e) {

        $(".contributionembedvideoidreset").css('display', 'block');

    });

    $(document).on('click', '.contributionembedbutton ', function () {

        $(".iframeyoutubevideo").css('display', 'block');
        $(".contributiongalleryvideofallback").css('display', 'none');
        $("#contributiongalleryvideoloadinggif").css('display', 'block');
        var youtube_url = $(".contributionembedvideoid").val();

        console.log(youtube_url);
        console.log(youtube_url.split('='));
        youtube_id = youtube_url.split('=')[1];
        console.log(youtube_id)
        youtuve_src = "https://www.youtube.com/embed/" + youtube_id;
        console.log(youtuve_src)


        $(".galleryvideoframe").attr('src', youtuve_src);

        videosrc = "https://www.youtube.com/embed/" + youtube_id;
        videoheight = "253";
        actual_video_src = "www.youtube.com/watch?v=" + youtube_id;
        var imagesrc = "https://img.youtube.com/vi/" + youtube_id + "/maxresdefault.jpg";
        var alterimage = new Image;
        alterimage.src = imagesrc;
        $(alterimage).one('load', function () {
            console.log(alterimage.height)
            console.log(alterimage.width)
            $("#contributiongalleryvideoloadinggif, #contributiongalleryvideoloadinggiftext").css('display', 'none');
            $(".imageuploadpopupcenter").center();
            // if (alterimage.height == '90' && alterimage.width == '120') {
            //     var alterimagesrc = "https://img.youtube.com/vi/" + ytubeid + "/0.jpg";
            //     embedimage(itemid, alterimagesrc, 'youtube');
            // }
            // else {
            //     embedimage(itemid, imagesrc, 'youtube');
            // }
            youtubeadjust(alterimage.width, alterimage.height);

            window.onresize = function () {
                // windowyoutubeadjust(alterimage.width , alterimage.height )
                youtubeadjust(alterimage.width, alterimage.height);
                // $(".imageselectiondiv").center();
                $(".imageuploadpopupcenter").center();
            };
    ...
    $(".contributionembedvideoidreset").on('click', function (e) {
        $(".contributionembedvideoid").val('');
        $(".contributiongalleryvideofallback").css('display', 'block');
        $(".iframeyoutubevideo").css('display', 'none');
        $(".galleryvideoframe").attr('src', '')
        $(".galleryvideoframe").removeAttr("style");
    });

    //for youtube search
    $('.contyoutubesearchbox').bind('keypress', function (e) {

        var code = e.keyCode;
        if (code == 13) {
            $('.contyoutubesearchbutton').click();
            return false;
        }
    });

    $(".imageuploadfromyoutubeholder").on('click', '.contyoutubesearchbutton', function () {
        $('.imageuploadpopupphoto').imgAreaSelect({remove: true});

        var searchphrase = $('.contyoutubesearchbox').val();
        var previoussearchphrase = $('#contyoutubesearchcheck').val();

        if (previoussearchphrase !== searchphrase) {
            $('.imageuploadpopupphotowrapperright').css("min-height", '280px');

            $('.contyoutubegallery').jScrollPane({autoReinitialise: true});
            $('.contyoutubegallery').data('jsp').destroy();
            $('.contyoutubegallery').hide();
            previoussearchphrase = $('#contyoutubesearchcheck').val(searchphrase);
            if (searchphrase != "") {

                $('#contyoutubeloading').css('display', 'block');
                ...
                $.get(
                    "https://www.googleapis.com/youtube/v3/search", {
                        ...
                        q: searchphrase,
                        type: 'video',
                        // key: 'AIzaSyCKMpw2nmPnon_gkh4EIXnbiAmrZNw-v4M'
                        key: 'AIzaSyCjn4uw1TXq0K0_79Aht4Y-9FFvl6_-5ls'
                    },
                    function (data) {
                        console.log(data);
                        $('#contyoutubeloading').css('display', 'none');
                        if (data.items.length > 0) {

                            $('.contyoutubeoutput').empty();
                            $('.contyoutubeoutput').show();
                            $('.contyoutubegallery').show();
                            $('.imageuploadpopupphotowrapperright').css("min-height", '280px');
                            youtubearray = data.items;

                            var youtubegalleryhtml = "";
                            var datacount = data.items.length;
                            for (var i = 0; i < datacount; i++) {
                                youtubegalleryhtml = youtubegalleryhtml + "<div class='conyoutubeoutputgalleryimagewrapperouter'><div style='background-image: url(images/nav/rmlloadingdark.gif); background-repeat: no-repeat; background-position: center; min-width: 20px;' class='conyoutubeoutputgalleryimagewrapper'><img class=conyoutubeoutputgalleryimage src='" + data.items[i].snippet.thumbnails.default.url + "'/></div></div>";
                            }

                            $(".contyoutubeoutput").append(youtubegalleryhtml);

                            var scrollPane = $('.contyoutubegallery').jScrollPane({
                            ...
                            $('.contyoutubegallery .jspPane').draggable({
                                ...
                                drag: function (event, ui) {
                                    ...
                                    if ($('.contyoutubeoutputcontainer').width() > $('#contyoutubegallery  .jspContainer').width()) {
                                        if (pos < -$('.contyoutubeoutputcontainer').width() + $('#contyoutubegallery  .jspContainer').width()) {
                                            $('.contyoutubegallery .jspPane .ui-draggable').css('left', -$('.contyoutubeoutputcontainer').width() + $('#contyoutubegallery .jspContainer').width());
                                            return false;
                                        }
                                        if (pos >= 0) {
                                            $('.contyoutubegallery  .jspPane .ui-draggable').css('left', 0);
                                            return false;
                                        }
                                    }
                                    else {
                                        $('.contyoutubegallery  .jspPane').css('left', 0);
                                        return false;
                                    }
                                }
                            });
                            var startingmouseposition = 0;
                            var endmouseposition = 0;
                            $(".contyoutubeoutput img").mousedown(function (e) {
                                startingmouseposition = e.pageX;
                            });
                            $(".contyoutubeoutput img").mouseup(function (e) {
                                endmouseposition = e.pageX;
                            });

                            firstyoutubevedio = "https://www.youtube.com/embed/" + data.items[0].id.videoId;

                            console.log(firstyoutubevedio);


                            $('.imageuploadpopupphotocontainer').html("<div  id='conyoutubeselectedimageloading'><img draggable='false' src='images/nav/rmlloadinglargedark.gif' /><div id='contyoutubeloadingtext'>Loading...</div></div>");

                            $('#conyoutubeselectedimageloading').fadeIn();
                            // var firstprocessedvideourl = "https://www.youtube.com/embed/" + data.items[0].id.videoId;


                            var maxdisplaywidth = $('#listimageuploadpopuptitle').width();
                            var maxdisplayheight = 400;
                            var currentnaturalheight = 9;
                            var currentnaturalwidth = 16;
                            ...
                            setTimeout(function () {
                                $(".conyoutubeselectedimageloading, .contyoutubeloadingtext").css('display', 'none');

                                $('.imageuploadpopupphotocontainer').html("<iframe id='conyoutubesearchiframe' class='imageuploadpopupphoto zerodeg'  src='" + firstyoutubevedio + "'  style='width:" + finalimagewidth + " ; height: " + finalimageheight + "'  frameborder='0' allow='autoplay; encrypted-media' allowfullscreen></iframe>")

                            }, 500);

                        }
                        else {
                            // showmediaerror('Image Upload','Sorry! The search returned zero matches from YouTube.');
                            // $('#' + selecteduniqueid + ' #youtubeloading').attr('aria-hidden', true);
                        }
                    })
                    .fail(function (data) {
    ...
    $(".imageuploadfromyoutubeholder ").on('click', '.conyoutubeoutputgalleryimagewrapperouter', function (e) {
        console.log($(this));

        $('.imageuploadpopupphoto').imgAreaSelect({remove: true});
        youtubeheight = $(this).children().find(".conyoutubeoutputgalleryimage").height();
        youtubewidth = $(this).children().find(".conyoutubeoutputgalleryimage").width();
        console.log($(this).children().find(".conyoutubeoutputgalleryimage"))
        console.log($(this).children().find(".conyoutubeoutputgalleryimage").attr('src'));
        youtubethisurl = $(this).children().find(".conyoutubeoutputgalleryimage").attr('src');
        youtubevedid = youtubethisurl.split('/')[4];
        console.log(youtubevedid)
        var maxdisplaywidth = $('#listimageuploadpopuptitle').width();
        var maxdisplayheight = 400;
        var currentnaturalheight = 9;
        var currentnaturalwidth = 16;
        ...
        var processedvideourl = "https://www.youtube.com/embed/" + youtubevedid;
        ...
        setTimeout(function () {
            ...
            $('.imageuploadpopupphotocontainer').html("<iframe id='conyoutubesearchiframe' class='imageuploadpopupphoto zerodeg'  src='" + processedvideourl + "'  style='width:" + finalimagewidth + " ; height: " + finalimageheight + "'  frameborder='0' allow='autoplay; encrypted-media' allowfullscreen></iframe>")
    ...
    $(".imageuploadfromgiphyholder").on('click', '.giphysearchbutton', function () {
      ...
      $(".giphysearchtext").val(searchphrase);
        ...
        $.ajax({
            ...
            if (datacount > 0) {
                ...
                $(".imagefromgiphyimageembedurl").val(data.data[0].embed_url);
                $(window).on("resize", function () {
                    adjustsize(GetOrientation($('.imageuploadpopupphoto')))
                });
            }
...
console.log(giphyarray);
        var urlid = giphyarray.findIndex((item) => item.id === giphyid);
        console.log(urlid);

        $(".imagefromgiphyimageembedurl").val(giphyarray[urlid].embed_url);
        $('.imageuploadpopupphotocontainer').html("<div class='loading' id='loading'><img draggable='false' src='images/nav/rmlloadinglargedark.gif' class='loadimg'/><div class='loadingtext'>Loading...</div></div>");
        ...
        $.ajax({
            ...
            if (datacount > 0) {
                ...
                img.onload = function () {
                    ...
                    $(".imagefromgettyimagesurl").val(gettyurl);
                };
    ...
    $(".imageuploadfromgettyholder").on('click', '.gettyoutputgalleryimagewrapperouter', function (e) {
        ...
        console.log((firstgettyimage.split('/')[4]).split('?')[0]);
        $(".imagefromgettyimages").val((firstgettyimage.split('/')[4]).split('?')[0]);
        $(".imagefromgettyimagesurl").val(firstgettyimage);
    ...
    $(".imageuploadpopupphotowrapperleftholder").on('click', '.imageuploadpopupuprotateimageleft', function (e) {
        ...
        // $(".imageuploadpopupphotocontainer").removeAttr("style");


        if ($(".imageuploadpopupphoto").hasClass('zerodeg')) {

            jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto twoseventydeg');

        } else if ($(".imageuploadpopupphoto").hasClass('twoseventydeg')) {

            jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto oneeightydeg');

        } else if ($(".imageuploadpopupphoto").hasClass('oneeightydeg')) {

            jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto ninetydeg');
        ...
        else if ($(".imageuploadpopupphoto").hasClass('flipzerodeg')) {

            jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto rotateninetydeg');

        }
        else if ($(".imageuploadpopupphoto").hasClass('rotateninetydeg')) {

            jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto rotateoneeightydeg');

        }

        else if ($(".imageuploadpopupphoto").hasClass('rotateoneeightydeg')) {

            jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto rotatetwoseventydeg');

        }
        else if ($(".imageuploadpopupphoto").hasClass('rotatetwoseventydeg')) {

            jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto flipzerodeg');

        }

        else if ($(".imageuploadpopupphoto").hasClass('fliptwoseventydeg')) {

            jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto rotatefliptwoseventydeg');

        }

        else if ($(".imageuploadpopupphoto").hasClass('rotatefliptwoseventydeg')) {

            jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto rotateninetydeg');
        }


        else if ($(".imageuploadpopupphoto").hasClass('fliponeeightydeg')) {

            jQuery('#imageuploadpopupphoto ').attr('class', 'imageuploadpopupphoto rotatetwoseventydeg');
        }

        else if ($(".imageuploadpopupphoto").hasClass('flipninetydeg')) {
        ...
        // if ($('.imageuploadpopupphoto').hasClass('zerodeg') == true || $('.imageuploadpopupphoto').hasClass('flipzerodeg') == true || $('.imageuploadpopupphoto').hasClass('oneeightydeg') == true || $('.imageuploadpopupphoto').hasClass('fliponeeightydeg') == true || $('.imageuploadpopupphoto').hasClass('rotateoneeightydeg') == true || $('.imageuploadpopupphoto').hasClass('rotatefliptwoseventydeg') == true  || $('.imageuploadpopupphoto').hasClass('twoseventydeg') == true) {

        if ($('.imageuploadpopupphoto').hasClass('zerodeg') == true || $('.imageuploadpopupphoto').hasClass('flipzerodeg') == true || $('.imageuploadpopupphoto').hasClass('oneeightydeg') == true || $('.imageuploadpopupphoto').hasClass('fliponeeightydeg') == true || $('.imageuploadpopupphoto').hasClass('rotateoneeightydeg') == true || $('.imageuploadpopupphoto').hasClass('rotatefliptwoseventydeg') == true) {
            ...
            setTimeout(function () {
                ...
                $('.imageuploadpopupphotocontainer').imgAreaSelect({remove: true});
                ias = $('.imageuploadpopupphotocontainer').imgAreaSelect({
                    onInit: function (img, selection) {
                        document.iasselectionx1 = selection.x1;
                        document.iasselectiony1 = selection.y1;
                        document.iasselectionx2 = selection.x2;
        ...
        window.onresize = function () {
            ...
            if ($('.imageuploadpopupphoto').hasClass('oneeightydeg') == true || $('.imageuploadpopupphoto').hasClass('zerodeg') == true || $('.imageuploadpopupphoto').hasClass('flipzerodeg') == true || $('.imageuploadpopupphoto').hasClass('rotateoneeightydeg') == true || $('.imageuploadpopupphoto').hasClass('rotatefliptwoseventydeg') == true) {

                // if ($('.imageuploadpopupphoto').hasClass('twoseventydeg') == true || $('.imageuploadpopupphoto').hasClass('oneeightydeg') == true  || $('.imageuploadpopupphoto').hasClass('zerodeg') == true || $('.imageuploadpopupphoto').hasClass('flipzerodeg') == true || $('.imageuploadpopupphoto').hasClass('rotateoneeightydeg') == true || $('.imageuploadpopupphoto').hasClass('rotatefliptwoseventydeg') == true) {
                ...
                // if($('.imageuploadpopupphoto').hasClass('zerodeg') == false || $('.imageuploadpopupphoto').hasClass('twoseventydeg') == false || $('.imageuploadpopupphoto').hasClass('oneeightydeg') == false ||
                //     $('.imageuploadpopupphoto').hasClass('ninetydeg') == false) {
                //     adjustsizeforimagerotate();
                //     adjustmarginsforimagerotate();
                // }
                var oldiasx1 = document.iasselectionx1;
                ...
                var oldiasx2 = document.iasselectionx2;
                var oldiasy2 = document.iasselectiony2;
                console.log("oldiasx1_" + oldiasx1)
                console.log("oldiasy1_" + oldiasy1)
                console.log("oldiasx2_" + oldiasx2)
                console.log("oldiasy2_" + oldiasy2)
                ...
                console.log("The previous width_" + previouswidth);
                console.log("The previous height_" + previousheight);
                console.log("The final Width_" + finalimagewidth);
                console.log("The final height_" + finalimageheight);
                document.iasselectionx1 = newiasx1;
                document.iasselectiony1 = newiasy1;
                document.iasselectionx2 = newiasx2;
                document.iasselectiony2 = newiasy2;
                ...
                console.log("the selectionx1_" + selectionx1)
                console.log("the selectiony1" + selectiony1)
                console.log("the selectionx2_" + selectionx2)
                console.log("the selectiony2_" + selectiony2)
                ...
                // if($('.imageuploadpopupphoto').hasClass('rotatetwoseventydeg') == true || $('.imageuploadpopupphoto').hasClass('rotateninetydeg') == true || $('.imageuploadpopupphoto').hasClass('rotateoneeightydeg') == true){
                adjustsizeforimagerotate();
                adjustmarginsforimagerotate();
                // }
                ...
                console.log("The oldx1_" + oldiasx1);
                console.log("The oldy1_" + oldiasy1);
                console.log("The oldx2_" + oldiasx2);
                console.log("The oldy2_" + oldiasy2);

                var newiasx1 = ((oldiasx1 * finalimagewidth) / previouswidth);
                var newiasy1 = ((oldiasy1 * finalimageheight) / previousheight);
                var newiasx2 = ((oldiasx2 * finalimagewidth) / previouswidth);
                var newiasy2 = ((oldiasy2 * finalimageheight) / previousheight);
                console.log("The newiasx1_" + newiasx1)
                console.log("The newiasy1_" + newiasy1)
                console.log("The newiasx2_" + newiasx2)
                console.log("The newiasy2_" + newiasy2)
        ...
        console.log(GetOrientation($(".imageuploadpopupphoto")));
    });
    ...
    $(".imageuploadpopupphotowrapper").on('click', '#imageuploadpopupbuttonselect', function (e) {
        ...
        embedgiphyurl =  $(".imagefromgiphyimageembedurl").val();
        console.log(embedgiphyurl);
        ...
        if ($('.imageuploadpopupphoto ').length > 0) {
            ...
            if ($('.imageuploadpopupphoto ').attr('src').indexOf('images/fallbackimages/itemimage.png') !== 0) {
                ...
                $(".orientation").val(GetOrientation($('.imageuploadpopupphoto ')));
                console.log("The image orientation_" + $(".orientation").val());
                ...
                $('#myForm_multi').ajaxForm({
                    ...
                    success: function (data) {
                        ...
                        if (typeof objects !== "undefined") {
                            ...
                            if (sorted_load[index]['imageraw'] != 'rml' && sorted_load[index]['gettyimageid'] == null && sorted_load[index]['giphyid'] == null && sorted_load[index]['gfycatid'] == null) {

                                image_str = "<img src='images/raw/" + sorted_load[index]['imageraw'] + "' class='multicontent' alt='No Image' id='content_" + sorted_load[index]['id'] + "' >";

                            }
                            else if (sorted_load[index]['image'] == '' && sorted_load[index]['gettyimageid'] != null && sorted_load[index]['giphyid'] == null && sorted_load[index]['gfycatid'] == null) {
                                image_str = "<img src='images/raw/" + sorted_load[index]['imageraw'] + "' class='multicontent thirdparty' alt='No Image' id='content_" + sorted_load[index]['id'] + "' >";
                            }
                            else if (sorted_load[index]['image'] == '' && sorted_load[index]['gettyimageid'] == null && sorted_load[index]['giphyid'] != null && sorted_load[index]['gfycatid'] == null) {


                                image_str =  "<img src='images/raw/" + sorted_load[index]['imageraw'] + "' class='multicontent thirdparty' alt='No Image' id='content_" + sorted_load[index]['id'] + "' style='display:none'><iframe  src='" + embedgiphyurl + "' id='content_" + sorted_load[index]['id'] + "' class='multicontent thirdparty'  frameborder='0' scrolling='no' width='100%' height='100%' style='position:absolute;top:0;left:0' allowfullscreen></iframe>";
                            ...
                            second_multistr = "</div><div class='hoverable' style='display: block'><a href='../content_with_image.php/" + sorted_load[index]['user_id'] + "'><img src='css/exm.jpg' alt='Paris' style='border:none ; border-radius:50%; background-color: white ; width:51px ;height:51px; position: relative; margin-top:20px; margin-left: 20px;'></a><div class='cont' style='display: none'>" + sorted_load[index]['id'] + "</div><div class='multimain-content'><span class='multicontributor_name'>" + sorted_load[index]['username'] + "</span></div><div class='multiopinion'><div class='multicontributionslikedislike'>";
    ...
    $('.gobackyoutube').on('click', function (e) {

        if ($(this).hasClass("gobackfromsearch") == true) {
            $(this).css('display', 'none');
            $(".contributiongalleryvideocontainer").css('display', 'block');
            $(".imageuploadfromyoutubeholder,.imageuploadpopupphoto ").css('display', 'none');
        }
    ...
    $(document).on("mouseover", '.contributionnewembedvideofeedback', function () {
        embedleft = parseInt($(".contributiongalleryvideobottomnav").width() - $(".emebebtable").width())
        $(".emebebtable").css('left', embedleft);
        $('.embedsupportlist').show();
        $(".imageuploadpopup").css('overflow', 'visible');
        window.onresize = function () {
            embedleft = parseInt($(".contributiongalleryvideobottomnav").width() - $(".emebebtable").width());
            console.log("left_" + embedleft);
            // $(".emebebtable").css('left', (-embedleft + 43));
            $(".emebebtable").css('left', (embedleft ));
            $(".imageuploadpopup").css('overflow', 'visible');
    ...
    $(document).on("mouseleave", '.contributionnewembedvideofeedback', function () {
        $('.embedsupportlist').hide();
        $(".imageuploadpopup").css('overflow', 'hidden');
    });
