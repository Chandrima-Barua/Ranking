    ...
    function readURL(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                // $(".imageuploadpopupphotocontainer").html("<img src='" + this.src + "' class='imageuploadpopupphoto " + orientclass + "' style='width:" + finalimagewidth + "px;height:" + finalimageheight + "px/>");
