...
//for resetting input file on change
        ...
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                ...
                img.onload = function () {
                    ...
                    // $('.imageuploadpopupphoto').css('transform', 'scaleX(-1)');
                    ...
                    if ($('.imageuploadpopupphoto').hasClass('zerodeg') == true || $('.imageuploadpopupphoto').hasClass('oneeightydeg') == true || $('.imageuploadpopupphoto').hasClass('fliponeeightydeg') == true) {
    ...
    function flipwindowresizeadjust(orientclass) {
            ...
            if (mimecheck(blob)) {
                ...
                $(window).on("resize", function () {
                    ...
                    if ($('.imageuploadpopupphoto').hasClass('zerodeg') == true || $('.imageuploadpopupphoto').hasClass('flipzerodeg') == true || $('.imageuploadpopupphoto').hasClass('oneeightydeg') == true || $('.imageuploadpopupphoto').hasClass('fliponeeightydeg') == true) {
                        ...
                        flipwindowresizeadjust(GetOrientation($('.imageuploadpopupphoto')));
    ...
    $(".imageuploadpopupphotowrapperleftholder").on('click', '.imageuploadpopupuprotateimageleft', function (e) {
        ...
        if ($(".imageuploadpopupphoto").hasClass('zerodeg')) {
            ...
            // jQuery('.imageuploadpopupphotocontainer').attr('class', 'imageuploadpopupphotocontainer rotateninetydeg');
            ...
            // jQuery('.imageuploadpopupphotocontainer').attr('class', 'imageuploadpopupphotocontainer rotateoneeightydeg');
